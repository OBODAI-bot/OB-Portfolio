...
```html
<!-- CURRENT -->
<title>Barnabas Obodai - Frontend Software Engineer</title>
<meta name="description" content="Barnabas Obodai - Ghanaian Frontend Software Engineer...">
...
```html
<!-- CURRENT -->
<meta property="og:title" content="Barnabas Obodai - Ghanaian Frontend Software Engineer">
...
```html
<!-- CURRENT -->
<meta name="twitter:title" content="Barnabas Obodai - Ghanaian Frontend Software Engineer">
...
```html
<!-- CURRENT -->
<span class="hero-name">Barnaba Obodai</span>
<span class="hero-subtitle">Frontend Software Engineer</span>
...
**Current**: 4-paragraph bio about Barnabas Obodai, Ghanaian software engineer
...
- **What Qualifies**:
  - Month and year ("Jan 2025 - Dec 2026")
  - Or just years ("2025 - 2026")
...
**Current**: Ipmc Computer Training

**Replace With**: Your educational background

#### **What Qualifies:**
- **Degree**: Full computer training name ("Bachelor of in Computer Training")
...
#### **Location (Line 581)**
- **Current**: "Kasoa, Ghana (Remote Available)"
...
- **Current**: "© 2025 Barnabas Obodai. All rights reserved."
